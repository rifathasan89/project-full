...
const adminNavItems = [
    ...
    { to: "/dashboard/saleinfo", icon: <MdPayments className="text-2xl" />, label: "Sale Information" },
];
...
const student = [
    ...
    { to: "/dashboard/my-task", icon: <MdPendingActions className="text-2xl" />, label: "My Task" },
